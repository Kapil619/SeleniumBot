...
class Booking(webdriver.Chrome):
    ...
    def report_results(self):
        ...
        hotel_data=[]
        for hotel in hotels:
            name = hotel.find_element(by=By.CSS_SELECTOR, value='div[data-testid="title"]').get_attribute('innerHTML').strip()
            print(name)
            hotel_price = hotel.find_element(by=By.CSS_SELECTOR, value='span[data-testid="price-and-discounted-price"]').get_attribute('innerHTML').strip()
            ...
            hotel_data.append({'name': name, 'price': hotel_price, 'score': hotel_score})
        return hotel_data
